...
const Register = ({ setCurrentView }: Props) => {
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-cursive text-green-900 mb-4 text-center">
        Become a Medusa Store Member
      </h1>

      <p className="text-center text-base text-green-900 py-4">
        Create your Medusa Store Member profile and enjoy an elevated shopping
        experience.
      </p>
